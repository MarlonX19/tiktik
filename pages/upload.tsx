      ...
      <div className="bg-white rounded-lg xl:h-[80vh] w-[65%] flex gap-6 flex-wrap justify-between items-center p-14 pt-6">
        <div>
          ...
          >
                ...
                {videoAsset ? (
                  <div>
                    <video
                      ...
                      loop
                      controls
                      className="rounded-xl h-[450px] mt-16 bg-black-800"
                    ></video>
                  </div>
                ) : (
                  <label className="cursor-pointer ">
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      <p className="text-gray-400 text-center mt-10 text-small">
            ...
            {wrongFileType && (
              <p className="text-center text-xl text-red-400 font-semibold mt-4 w-[200px]">
